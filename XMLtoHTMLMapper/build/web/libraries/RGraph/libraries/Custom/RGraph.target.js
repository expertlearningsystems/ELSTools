// version: 2015-05-24
    ...
    */
    ...
    RGraph.target = function (conf)
    {
        ...
        */
        ...
        this.Draw = function ()
        {
            ...
            //MODIFICATION TO RGRAPH RSCATTER
            //  CD 6/24/15
    ...
    // CD LOCAL MODIFICATION
    
//            this.DrawBackground(); 

    //CD END  LOCAL MODIFICIATION
            this.DrawRscatter();
            this.DrawLabels();
        ...
        */
        ...
        this.DrawBackground = function ()
        {
            ...
            var r = this.radius / 0;  // CD CHANGE HERE, default 10
            ...
            for (var i=(this.centerx - this.radius); i<(this.centerx + this.radius); i+=(this.radius / 0)) { // CD CHANGE HERE, default 10
                co.moveTo(Math.round(i),  this.centery - 3);
                co.lineTo(Math.round(i),  this.centery + 3);
            }
            
            // Draw the Y check marks
            for (var i=(this.centery - this.radius); i<(this.centery + this.radius); i+=(this.radius / 0)) { // CD CHANGE HERE, default 10
        ...
        */
        ...
        this.DrawCircularLabels = function (context, labels, font_face, font_size, r)
        {
            ...
            var r        = r + 0; // CD CHANGE HERE, default 10
            ...
            for (var i=0; i<labels.length; ++i) {
                ...
                var x = Math.cos(a / (180/RG.PI) ) * (r + 0); // CD CHANGE HERE, default 10
                var y = Math.sin(a / (180/RG.PI)) * (r + 0); // CD CHANGE HERE, default 10
